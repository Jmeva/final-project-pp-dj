...
1. Clona el repositorio en la ubicación de tu preferencia dentro de tu ordenador con el comando git clone seguido de la liga SSH que proporciona GitHub.
